...
//  DiaryPhotoDemo
//
//  Created by Kiên Nguyễn on 12/26/17.
...
class CreateVideoFromImages: NSObject {
    ...
    func createMovieFrom(images: [UIImage], withCompletion: @escaping CXEMovieMakerCompletion){
        ...
        self.createMovieFromSource(images: listImage, extractor: {(inputObject:AnyObject) -> UIImage? in
